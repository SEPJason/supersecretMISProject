...
public class HotelMain {
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		//ask how many rooms user wants? handicap accessible? Kitchen Y/n, etc. and book room based on 
		...
		while (ins.hasNextLine()) {
	      ...
	      {  
	         ...
	         if (cmd.equalsIgnoreCase("G")) {
	        	 System.out.println("Would you like to B)ook a reservation, V)iew your current reservation, C)heck in, or check O)ut?");
		          cmd = in.nextLine();
	         ...
	         { 
	          System.out.println("Would you like to check O)ccupany, view G)uest count, or check what room needs U)pkeep?");
	          cmd = in.nextLine();
